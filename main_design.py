...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(9, 340, 721, 107))
        ...
        self.previous.setMinimumSize(QtCore.QSize(50, 50))
        self.previous.setMaximumSize(QtCore.QSize(50, 50))
        ...
        self.playState.setMinimumSize(QtCore.QSize(65, 65))
        self.playState.setMaximumSize(QtCore.QSize(65, 65))
