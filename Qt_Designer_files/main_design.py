...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.controlView.setGeometry(QtCore.QRect(20, 270, 631, 130))
        ...
        self.menuFile.addAction(self.actionAdd_Subtitle_File)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionJump_Forward.setShortcut(_translate("MainWindow", "Ctrl+Shift+Num++", None))
        self.actionJump_Backward.setText(_translate("MainWindow", "Jump Backward", None))
        self.actionJump_Backward.setShortcut(_translate("MainWindow", "Ctrl+Shift+Num+-", None))
